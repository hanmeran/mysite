...
E-Mail-Adresse: [mail@akkaya.it](mailto:info@orhanakkaya.de).

Impressum: [https://orhanakkaya.de/imprint](https://orhanakkaya.de/imprint).
...
*   **BorlabsCookie:** Cookie-Einwilligungs-Management; Dienstanbieter: Borlabs; Website: [https://de.borlabs.io/borlabs-cookie/](https://de.borlabs.io/borlabs-cookie/); Es werden eine individuelle Nutzer-ID, Sprache sowie Arten der Einwilligungen und der Zeitpunkt ihrer Abgabe serverseitig und im Cookie auf dem Gerät der Nutzer gespeichert.
...
*   **Google Analytics:** Onlinemarketing und Webanalyse; Dienstanbieter: Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA; Website: [https://marketingplatform.google.com/intl/de/about/analytics/](https://marketingplatform.google.com/intl/de/about/analytics/); Datenschutzerklärung: [https://policies.google.com/privacy](https://policies.google.com/privacy); Widerspruchsmöglichkeit (Opt-Out): Opt-Out-Plugin: [https://tools.google.com/dlpage/gaoptout?hl=de](https://tools.google.com/dlpage/gaoptout?hl=de), Einstellungen für die Darstellung von Werbeeinblendungen: [https://adssettings.google.com/authenticated](https://adssettings.google.com/authenticated).
